...
- Backtest single or multi-strategy portfolios with configurable capital allocation and risk limits.
...
| Backtest outputs empty reports | Strategies produced no BUY signals for the window. | Check data quality, broaden strategies, or extend lookback period. |
